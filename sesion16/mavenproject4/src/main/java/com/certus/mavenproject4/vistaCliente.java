...
public class vistaCliente extends javax.swing.JFrame {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            objLogic.conectarDB();
            objLogic.mostrarRegistrosCodigo(codigo);
            objLogic.rs.next();
            txtcod.setText(String.valueOf(objLogic.rs.getInt("codcli")));
            txtnom.setText(objLogic.rs.getString("nomcli"));
            txtmail.setText(objLogic.rs.getString("correo"));
            txtclave.setText(objLogic.rs.getString("clave"));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            objLogic.conectarDB();
            objLogic.updateSQL(codcli, nomcli, correo, clave);
